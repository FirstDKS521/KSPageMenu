...
@interface KSPageSegmentedTitleView ()
...
@implementation KSPageSegmentedTitleView
...
//初始化方法
- (void)initSegmentedWithConfig:(KSPageMenuConfig *)config {
    self.config = config;
